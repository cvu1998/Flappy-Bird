...
public:
    ...
    {
        if (!readWeightVectorFromFile("res/AI/FlappyBirdWeightVector.rl"))
            TrainAgent = true;
    }
...
public:
    FlappyBirdScene(unsigned int width, unsigned int height, bool* vsync);
    ~FlappyBirdScene();
